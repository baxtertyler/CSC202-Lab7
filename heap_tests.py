...
class TestHeap(unittest.TestCase):
    ...
    def test_04_build_heap(self):
        ...
        test_heap = MaxHeap(15)
        test_heap.build_heap([5, 8, 2, 5, 8, 0, 4, 8, 2, 9])
        self.assertEqual(test_heap.contents(), [9, 8, 4, 8, 8, 0, 2, 5, 2, 5])
    ...
    def test_09_perc_down(self):
        ...
        self.assertEqual(test_heap.contents(), [9, 6, 8, 2, 5, 7])
        test_heap = MaxHeap()
        test_heap.build_heap([1, 9, 6, 8, 2, 5, 7])
        test_heap.perc_down(1)
        self.assertEqual(test_heap.contents(), [9, 8, 7, 1, 2, 5, 6])
        test_heap = MaxHeap()
        test_heap.build_heap([7, 6, 8, 2, 5])
        test_heap.perc_down(1)
        self.assertEqual(test_heap.contents(), [8, 6, 7, 2, 5])

        t = MaxHeap(4)
        t.build_heap([1, 4, 3, 2])
        self.assertEqual(t.contents(), [4, 2, 3, 1])
        t.perc_down(2)
        self.assertEqual(t.contents(), [4, 2, 3, 1])
